...
<head>
    ...
    <style>
        ...
        body {
            background: linear-gradient(135deg, #3a2a0f 0%, #6b4d1a 50%, #3a2a0f 100%);
        }
        .break-pulse {
...
<body class="min-h-screen p-6 text-white font-sans">
    ...
    <section class="max-w-7xl mx-auto text-center mb-16 animate-fade-in">
        <h1 class="text-6xl md:text-8xl font-black mb-6 gradient-text bg-gradient-to-r from-amber-300 via-yellow-400 to-orange-500 break-pulse">
            BREAKDANCE FLOW
        </h1>
        <p class="text-xl md:text-2xl text-amber-200 max-w-3xl mx-auto font-medium">
        ...
        <div class="mt-8 flex justify-center space-x-4">
            ...
            <a href="#categories" class="px-8 py-3 border-2 border-yellow-400 hover:border-amber-300 rounded-full font-bold text-amber-100 transition-all duration-300 hover:text-white">
                Explorar
            </a>
        </div>
    </section>
    ...
    <section class="max-w-5xl mx-auto mb-16 bg-amber-900/30 rounded-3xl overflow-hidden shadow-2xl backdrop-blur-sm border border-amber-400/20">
        <div class="aspect-w-16 aspect-h-9 bg-black relative">
            <!-- Video Player Placeholder -->
            <div id="main-video" class="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-900 to-amber-900">
                <div class="text-center p-8">
                    ...
                    <p class="text-amber-300">Haz clic en cualquier video de la galería para reproducirlo aquí</p>
                </div>
            </div>
        </div>
        <div class="p-6">
            <h2 id="video-title" class="text-3xl font-bold text-amber-300 mb-2">Título del Video</h2>
            <p id="video-desc" class="text-amber-200">Descripción del video seleccionado aparecerá aquí</p>
        </div>
    </section>

    <!-- Video Gallery -->
    <section id="video-gallery" class="max-w-7xl mx-auto">
        <h2 class="text-4xl font-bold mb-8 text-center gradient-text bg-gradient-to-r from-amber-300 to-yellow-400">
    ...
    <section id="categories" class="max-w-7xl mx-auto mt-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Foundations -->
            <div class="bg-amber-900/40 rounded-2xl p-8 border-2 border-amber-400/20 hover:border-amber-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-amber-400/10 backdrop-blur-sm">
                <div class="w-16 h-16 bg-amber-400 rounded-full flex items-center justify-center mb-6 text-gray-900 text-2xl font-bold">
                    B
                </div>
                <h3 class="text-2xl font-bold text-amber-300 mb-4">Básicos</h3>
                <p class="text-amber-200 mb-6">Fundamentos esenciales para construir tu técnica de breakdance.</p>
            ...
            <!-- Style -->
            <div class="bg-amber-900/40 rounded-2xl p-8 border-2 border-yellow-400/20 hover:border-yellow-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-yellow-400/10 backdrop-blur-sm">
                <div class="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center mb-6 text-gray-900 text-2xl font-bold">
                    S
                </div>
                <h3 class="text-2xl font-bold text-yellow-300 mb-4">Estilo</h3>
                <p class="text-amber-200 mb-6">Desarrolla tu flow personal y originalidad en el dance.</p>
                <a href="#video-gallery" class="inline-block px-6 py-2 bg-yellow-400 hover:bg-yellow-500 rounded-full font-bold text-gray-900 transition-all duration-300">
                    Ver Movimientos
                </a>
            </div>
            
            <!-- Power -->
            <div class="bg-amber-900/40 rounded-2xl p-8 border-2 border-orange-400/20 hover:border-orange-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-orange-400/10 backdrop-blur-sm">
                <div class="w-16 h-16 bg-orange-400 rounded-full flex items-center justify-center mb-6 text-gray-900 text-2xl font-bold">
                    P
                </div>
                <h3 class="text-2xl font-bold text-orange-300 mb-4">Power</h3>
                <p class="text-amber-200 mb-6">Movimientos acrobáticos y giros que roban el show.</p>
                <a href="#video-gallery" class="inline-block px-6 py-2 bg-orange-400 hover:bg-orange-500 rounded-full font-bold text-gray-900 transition-all duration-300">
                    Ver Movimientos
                </a>
            </div>
        </div>
    ...
    <section class="max-w-4xl mx-auto mt-24 mb-16 text-center">
        <h2 class="text-4xl md:text-5xl font-bold mb-6 gradient-text bg-gradient-to-r from-amber-300 to-orange-400">
        ...
        <button class="px-10 py-4 bg-gradient-to-r from-amber-400 to-yellow-500 hover:from-amber-500 hover:to-yellow-600 rounded-full font-bold text-gray-900 text-lg transition-all duration-300 hover:shadow-lg hover:shadow-amber-400/30 transform hover:-translate-y-1">
